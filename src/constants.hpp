...
inline constexpr int COLOR_PLAYER_FIRST = 1;
inline constexpr int COLOR_PLAYER_SECOND = 2;
inline constexpr int COLOR_PLAYER_THIRD = 3;
inline constexpr int COLOR_PLAYER_FOURTH = 4;
inline constexpr int COLOR_APPLE = 5;
